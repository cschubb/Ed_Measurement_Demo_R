...
Different software is available to conduct this type of analysis, including SPSS, Microsoft Excel, SAS, and others (Gotzmann & Bahry, 2012; Li, 2006).  We particularly focus on R statistical programing (R Core Team, 2023), which is a free software used for computing and graphics.  One of the many advantages of R is that it is free and open-source and uses packages to conduct different statistical analysis.
...
describe(), is function from the *psych* package, which will be used to demonstrate item analysis below. This was used to produce descriptive statistics to check the data. This function provides a table with a variety of descriptive statistics that are useful in evaluating test items.
...
Note this package was previously loaded to calculate the summary statistics. We repeat this step here specifically for item analysis.
